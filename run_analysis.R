...
write.table(subject,".\\merged\\subject.txt",quote=FALSE,row.names=FALSE)
...
write.table(y,".\\merged\\y.txt",quote=FALSE,row.names=FALSE)
...
write.table(X,".\\merged\\X.txt",quote=FALSE,row.names=FALSE)
...
write.table(final,".\\merged\\final.txt",quote=FALSE,row.names=FALSE)
